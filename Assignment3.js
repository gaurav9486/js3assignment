...
function renderProducts(imageUrl, imageTitle, imageBrand, imagePrice) {
  ...
  photoCard.appendChild(productPhoto);
  photoCard.appendChild(productDetails);

  var mainTitle = document.createElement("h3")
  var brandName = document.createElement("h4")
  var productPrice = document.createElement("p")
  productDetails.appendChild(mainTitle);
  ...
  productPhoto.src = imageUrl;
  mainTitle.innerText = imageTitle;
  brandName.innerText = imageBrand;
  productPrice.innerText = imagePrice;
}

for (pos = 0; pos < 5; pos++) {
    renderProducts(productList[pos].preview, productList[pos].name, productList[pos].brand, productList[pos].price);
}


function renderProducts2(imageUrl, imageTitle, imageBrand, imagePrice) {
    var photoCard = document.createElement("div");
    var productPhoto = document.createElement("img");
    var productDetails = document.createElement("div");
  
    var photosSection2 =  document.getElementById("photos-section-2");
    photosSection2.appendChild(photoCard);
    photoCard.appendChild(productPhoto);
    photoCard.appendChild(productDetails);
  ...
  for (pos = 5; pos < productList.length; pos++) {
      renderProducts2(productList[pos].preview, productList[pos].name, productList[pos].brand, productList[pos].price);
  }